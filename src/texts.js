...
export const INGREDIENTS = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        highlight: "vanilla extract",
        text: "1 teaspoon pure vanilla extract",
      },
      {
        highlight: "lemon juice",
      ...
      {
        italic: true,
        highlight: ["topping suggestions:", "(recipe in notes)"],
